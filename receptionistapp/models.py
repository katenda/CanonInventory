...
class Driver(models.Model):
    ...
    attached_car=models.ForeignKey(Car,on_delete=models.CASCADE)
...
class Complaints(models.Model):
    ...
    complainant=models.ForeignKey(Driver,on_delete=models.CASCADE,blank=True,null=True)
...
############################################
# The manager models start here
###############################################


class SystemUser(models.Model):
    email=models.EmailField(max_length=255,default='abc123@gmail.com',unique=True)
    ...
    role_choices = (
        ...
        ('Executive', 'Executive'),)
    role = models.CharField(max_length=100, choices=role_choices, default="Receptionist" ,null=True,blank=True)
